...
const VerifyEmail = () => {
    ...
    return (
        <div className="pt-28 min-h-screen">
            <Meta title="Verify Email | Alumni NITSGR" />
            <div className="flex items-center justify-center flex-col h-[60vh] gap-10">
                ...
                {!mailsent.sent && <div className="flex items-center gap-5 flex-col">
                    ...
                    <button disabled={loading} onClick={sendVerificationMail} className="bg-[#4B164C] disabled:bg-gray-500 hover:bg-black active:bg-gray-500 text-gray-900 font-medium px-6 py-2.5 rounded-2xl">
                        {
