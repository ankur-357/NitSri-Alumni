        ...
        <div className="flex justify-center items-center min-h-screen">
            ...
            {isAccountCreated ?
                <div className="flex items-center justify-center flex-col max-w-lg">
                    <img src="/public/images/logo515.png" alt="logo" height={200} width={200} className="lg:h-20 h-14 lg:w-20 w-14 rounded-full" />
                    ...
                    <Link to="/admin/signin" className="mt-5">
                ...
                !accAlreadyExist && <div className="lg:w-[28rem] md:w-[28rem] w-[90%] border-gray-700 border p-8 rounded-3xl bg-[#0c0c0c]">
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-2 px-3">
                        ...
                        <button
                            disabled={loading}
                            className="py-2.5 mt-3 px-5 rounded-xl bg-[#4B164C] hover:bg-black focus:bg-gray-600 text-white font-semibold"
                            type="submit"
                        >
                        ...
                        <p className="text-center mt-5">
                            ...
                            <Link to="/admin/signin" style={{ textDecoration: "none", color: "skyblue" }} className="text-sky-500">
                                Login
                            </Link>
                        </p>
                    </form>
