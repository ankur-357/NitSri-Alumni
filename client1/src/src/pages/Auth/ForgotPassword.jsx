        ...
        <div className="flex justify-center items-center min-h-screen">
            ...
            <div className="lg:w-[28rem] md:w-[28rem] w-[90%] border-gray-700 border p-8 rounded-3xl bg-[#0c0c0c]">
                ...
                <form onSubmit={handleForgotPassword} className="mb-5">
                    ...
                    <button type="submit" className="py-2.5 px-5 rounded-xl bg-[#4B164C] hover:bg-black focus:bg-gray-600 text-white font-bold w-full mt-6">
                        Submit
                    </button>
                </form>
                ...
                <Link to="/admin/signin" className="m-auto pt-0">
