...
const GiveTestimonial = () => {
  ...
  return (
    <div className='lg:px-9 px-4'>
      <Meta title="Give Testimonial | Alumni NITSGR" />
            ...
            <form className='flex gap-3 flex-col' onSubmit={handleSubmit}>
              ...
              <div className='flex md:flex-row flex-col gap-3'>
                <div className="flex-1">
                  ...
                  <input required={true} value={formData.currentLocation} onChange={handleInputChange} type="text" id="currentLocation" placeholder="Hazratbal Srinagar, J&K 800006" className='w-full bg-gray-950 text-gray-300 px-4 py-2 rounded-lg' />
                </div>

                <div className="flex-1">
                  <label htmlFor="currentCity" className='text-gray-300'>Current City</label> <span className='text-rose-500 text-xl'>*</span>
                  <input required={true} value={formData.currentCity} onChange={handleInputChange} type="text" id="currentCity" placeholder="Srinagar" className='w-full bg-gray-950 text-gray-300 px-4 py-2 rounded-lg' />
                </div>
              </div>
