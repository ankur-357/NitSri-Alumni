...
const Blogs = () => {
    ...
    return (
        <div className='my-10 mb-36 lg:px-16 md:px-6 px-6'>
            ...
            <Link data-aos="zoom-in" to="/blogs" className='bg-[#4B164C] absolute lg:right-20 md:right-16 right-12 hover:bg-black text-white font-semi-bold py-2 px-4 rounded-full flex items-center'>
