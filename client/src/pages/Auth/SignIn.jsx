...
const Login = () => {
    ...
    return (
        <div className="flex items-center justify-center h-screen w-full">
            <Meta title="Login | Alumni NITSGR" />
            <div className="lg:w-[28rem] md:w-[28rem] sm:w-[90%] w-[95%] border-gray-700 border py-8 lg:px-8 md:px-7 px-4 rounded-3xl bg-[#050505]">
                <div className="flex items-center justify-center">
                    <img src="images/logo515.png" height={200} width={200} alt="logo" className="lg:h-20 h-14 lg:w-20 w-14 rounded-full" />

                </div>
                <div>
                    <h1 className="text-center text-xl font-semibold leading-normal py-6">
                        Welcome to <br /><span className="text-sky-500">NITSGR Alumni Portal!</span>
                    </h1>
                </div>
                ...
                <form onSubmit={handleSubmit(Login)} className="flex flex-col gap-4 px-3 w-full">
                    ...
                    <button disabled={loading} type="submit" className="py-2.5 mt-3 px-5 rounded-xl bg-[#4B164C] hover:bg-black disabled:bg-gray-600 focus:bg-gray-600 text-white font-bold">
