...
const Alumni = () => {
    ...
    const { data: alumni, isLoading, isError, refetch } = useQuery({
        queryKey: ['66d769cc0004f4437921', alumniId],
        queryFn: () => getDocument('66d769cc0004f4437921', alumniId)
    });
    ...
    const onSubmit = async (data) => {
        try {
            ...
            await updateDocument('66d769cc0004f4437921', alumniId, alumniData);
            await refetch();
                    ...
                    <div className='bg-gray-800 p-5 pb-8 rounded-xl mt-10'>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className='flex md:flex-row flex-col gap-5'>
                            ...
                            <Select
                                ...
                                className='bg-gray-900 rounded-lg px-3 py-2 mt-1 w-full text-gray-300'
                            />
                            <button disabled={loading} onClick={handleSubmit(onSubmit)} className='bg-[#4B164C] hover:bg-black disabled:bg-gray-600 h-10 self-end px-5 py-2 mt-2 rounded-lg cursor-pointer text-white'>Submit</button>
                        </form>
                    </div>
